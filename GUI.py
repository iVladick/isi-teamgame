...
class SudokuGUI:
    ...
    def create_grid(self):
        ...
        for i in range(grid_size + 1):
            # Горизонтальні лінії
            self.canvas.create_line(50,150+ i * cell_size, FIELD_RENDER_SIZE+50, 150+i * cell_size, fill="black")
            # Вертикальні лінії
            self.canvas.create_line(50+i * cell_size, 150, 50+i * cell_size, 150+FIELD_RENDER_SIZE, fill="black")
        ...
        for i in range(section_size, grid_size, section_size):
            ...
            self.canvas.create_line(50, 150+i * cell_size, 50+FIELD_RENDER_SIZE, 150+i * cell_size, fill="black", width=2)
            # Товсті вертикальні лінії
            self.canvas.create_line(50+i * cell_size, 150,50+ i * cell_size, 150+FIELD_RENDER_SIZE, fill="black", width=2)
        self.fill_grid()
        ...
        for row in range(grid_size):
            for col in range(grid_size):
                ...
                if value != 0:  # Якщо клітинка не порожня
                    ...
                    self.canvas.create_text(x, y, text=str(value), font=("Arial", FONT1_SIZE), fill="blue")
